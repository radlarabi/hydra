...
export default function JoinForm(){
    return (
        <div className=" min-h-[100vh] flex flex-col justify-center pt-[10vh]">
            <div className="ml-[10vw] mr-[10vw]  bg-gray-800 rounded-[100px] bg-gradient-to-r from-purple-card via-custom-radial1 to-purple-card">
                <div className="title  min-h-[20vh] w-full flex flex-col items-center justify-center">
                ...
                <form action="">
                    <div className="form min-h-[80vh] w-full">
                        ...
                        <div className="flex justify-center items-center pb-4">
                            <textarea className="h-[7vh] w-[61vw] min-h-[30vh] rounded-3xl bg-transparent text-white  border-white border-[1px] pl-5 placeholder:pt-5 " placeholder="Tell Us Something...">
