...
export default function Intorduction(){
    return (
        <div className="flex flex-col">
            <div className="introTitle  h-[20vh] flex flex-row">
                <div className="intro1  h-full w-[50vw] flex flex-col pl-[2vw]">
                    <div className="title  w-full h-full flex justify-start items-end ">
                        <p className="text-slate-50 font-nav tracking-[0.09rem] font-semibold text-[36px]">
                            INTRODUCTION
                        </p>
                    </div>
                    <div className="subtitle  w-full h-full flex  ">
                        <p className="text-slate-50 font-nav tracking-[0.09rem] text-[36px]">
                            TO HYDRA VR
                        </p>
                ...
                <div className="intro2 bg-pue-200 h-full w-[50vw] flex justify-center items-center">
                    <p className="text-[16px] text-slate-50 font-nav tracking-[0.09rem] ">
            ...
            <div className="aboutVr  h-[60vh] flex flex-row">
                ...
                <div className="intro2  h-full w-[50vw] flex flex-col">
                    ...
                    <div className="aboutSubtitle  h-4/6 w-full flex justify-center items-start flex-col">
                        <p className="text-slate-50 font-nav tracking-[0.09rem] text-[36px] font-semibold">
                            ABOUT
                        </p>
                        <p className="text-slate-50 font-nav tracking-[0.09rem] text-[36px] ">
                            HYDRA VR
                        </p>
                        <p className="text-[16px] pt-[2vh] pb-[2vh] text-slate-50 font-nav tracking-[0.09rem] ">
                        ...
                        <button className="text-gray-800 text-[12px] font-nav tracking-[0.09rem] font-semibold p-3 bg-gradient-to-r from-purple-500 to-purple-300 rounded-3xl pl-6 pr-6">
                            LET'S GET IN TOUCH
                        </button>
                    </div>
            ...
            <div className="whyHydra  h-[20vh] flex flex-row">
                <div className="intro1  h-full w-[50vw] flex flex-col pl-[2vw]">
                    ...
                    <div className="subtitle  w-full h-full flex justify-start items-start pt-[1vh] text-[36px]">
                        <p className="text-slate-50 font-nav tracking-[0.09rem] ">
                            WITH HYDRA ?
                        </p>
                    </div>
                </div>
                <div className="intro2  h-full w-[50vw] flex justify-center items-center">
                    <p className="text-slate-50 font-nav tracking-[0.09rem] text-[16px]">
                        Vitae sapien pellentesque habitant morbi tristique senectus et netus et. Feugiat 
                        nibh sed pulvinar proin gravida hendrerit lectus. Mi sit amet mauris commodo 
                        quis imperdiet massa tincidunt nunc. Viverra aliquet eget sit amet tellus. Ornare 
                        lectus sit amet est placerat in. Lectus magna fringilla urna porttitor rhoncus vitae.
